    ...
    <section className="hidden md:flex md:w-84 md:flex-col md:fixed md:inset-y-0">
      <div className="flex flex-col flex-grow border-r border-gray-200 bg-white overflow-y-auto">
        <div className="h-14 bg-p-600 flex items-center justify-between flex-shrink-0 px-4">
          ...
          {walletAddress && (
            <button
              className="inline-flex items-center h-6 px-4 py-1 my-4 bg-p-400 hover:bg-p-300 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 border border-p-300 text-xs font-semibold tracking-wide text-white rounded"
